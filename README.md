...
How to use the LIS2MDL part API.

It illustrates it by getting the values of the magnetometer (in mGauss) and displaying them on a terminal.
...
- Select the appropriate IoC2 file based on the combination of NUCLEO and X-NUCLEO boards. For example, use c562re_iks01a3_lis2mdl_datalog_i2c.ioc2 for NUCLEO-C562RE and X-NUCLEO-IKS01A3.
...
More information about LIS2MDL part driver can be found in the [LIS2MDL Part Driver](https://dev.st.com/stm32cube-docs/part-drivers-lis2mdl/1.1.0/en/index.html)
